...
paragraphs = re.findall(r'<br>(.*?)</br>',str(respData)) #inbetween paranthesis is content we're looking for iven is everything between paragragh tags

for eachbr in paragraphs:
    print (eachbr)